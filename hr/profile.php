...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="../hr/profile.php"><?php echo ucwords(basename($_SERVER['PHP_SELF'],'.php')); ?></a></li>
      </ol>
    </section>
			...
			<div class="active tab-pane" id="personal">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="experience" placeholder="Experience" value="<?php echo $_SESSION["experience"];?>"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
