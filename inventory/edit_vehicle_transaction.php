...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Edit Transaction From Vehicles
      </h1>
      <ol class="breadcrumb">
	...
	<?php
			$id=$_REQUEST['code'];
			$sql="SELECT * from vehicle where vehicle_ID='".$rec0['vehicle_ID']."'";
			$result=mysqli_query($db,$sql);
        ...
        <div class="col-md-6">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#personal" data-toggle="tab">Vehicle Details</a></li>
			...
			<div class="active tab-pane" id="personal">
                <form class="form-horizontal"  action=" " >
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="driver" name="driver" value='<?php echo $rec['driver'];?>' disabled>
                    </div>
                  </div>
					<div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="veh_num" name="veh_num" value='<?php echo $rec['veh_num'];?>' disabled>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="area" name="area" value='<?php echo $rec['area'];?>' disabled>
                    </div>
                  </div>
					 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="passport" name="passport" value='<?php echo $rec['passport'];?>' disabled>
                    </div>
                  </div>
				  <div class="form-group">
