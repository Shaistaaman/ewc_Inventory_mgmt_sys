                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" id="vehicle" name="vehicle" style="width: 100%;">
                      <option selected="selected"></option>
						<?php 
                            $sql1="SELECT vehicle_ID,driver FROM vehicle ";
                            $result1=mysqli_query($db,$sql1);
                            while($rec1=mysqli_fetch_array($result1)) 
                             {
						?> 
                      <option value="<?php echo $rec1['vehicle_ID'];?>"><?php echo $rec1['driver'];?></option>
                      <?php } ?>
                    </select>
                  </div><!-- /.form-group -->
					<?php
