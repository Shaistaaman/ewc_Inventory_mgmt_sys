...
if(isset($_POST['submit']) && $_POST['submit'] == 'Add' )
{
				   ...
				   $sql="INSERT INTO vehicle (driver,passport,area,phone,email,veh_num) values('$driver','$passport','$area','$phone','$email','$veh_num')";
          ...
          <div class="nav-tabs-custom">
			...
			<div class="active tab-pane" id="personal">
                <form class="form-horizontal" method="post" action=" " id="addemploye" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="driver" name="driver" placeholder="Ali Ahmed" >
                    </div>
                  </div>
					<div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="veh_num" name="veh_num" placeholder="LX- 023 56" >
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="area" name="area" placeholder="Riyadh City" >
                    </div>
                  </div>
					<div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="passport" name="passport" placeholder=" 123456" >
                    </div>
                  </div>
				  <div class="form-group">
