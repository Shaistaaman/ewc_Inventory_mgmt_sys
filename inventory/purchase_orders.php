        ...
        <section class="content-header">
		 ...
		 <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Select PO and press Go</h3>
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control select2" name="purchase_order" id="purchase_order" style="width: 100%;">
                      <option selected="selected">Select</option>
						<?php			
						$sql="SELECT distinct purchase_order, cashcredit from inventory";
						$result=mysqli_query($db,$sql);
						while($rec=mysqli_fetch_array($result))
						{
						
						?>
                      <option value="<?php echo $rec['purchase_order']; ?>"><?php echo $rec['purchase_order']; ?></option>
                      <?php } ?>
                    </select>
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <div class="table-responsive">
				  <form  method="post" action="purchase_order-print.php?purchase_order=<?php echo $purchase_order;?>" target="_blank">
                <table class="table">
					<tr>
