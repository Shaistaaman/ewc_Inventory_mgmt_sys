...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Show All Items at Vehicles</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Vehicles Stock</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				   ...
				   <?php 
							...
							$count=0;
                            $sql="SELECT * FROM transaction where vehicle_id <> 0 ";
                  ...
                  <a  href="edit_vehicle_transaction.php?code=<?php echo $rec['trans_ID'];?>&action=edit" style="color: white">Edit</a>
                  </button>
                  ...
                  <a  href="vehicle_stock.php?code=<?php echo $rec['trans_ID'];?>" style="color: white">Delete</a>
                  </button>
                  </td>
				  </tr>
				  <?php } ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
            	<form action="../inventory/add_inv.php?code=vehicle" method="post" id="modalbody" name="modalbody">
